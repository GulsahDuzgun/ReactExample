...
const Product = ({product, favoriteFlag}) => {   
        ...
        <div className="product" key={product.id}>
            <div className="productHeader">
                <div className="product-picture">
                    <button className={favoriteFlag ? 'favoriteBtn isActive' : 'favoriteBtn'}  id={`favoriteBtn__${product.id}`} onClick={() => handleFavoriteBtn(product)}>
